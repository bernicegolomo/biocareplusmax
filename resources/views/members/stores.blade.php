						...
						<div class="tab-pane fade show active" id="dashboard" role="tabpanel">
							<div class="dashboard-content">
                                ...
                                @if(isset($stores) && count($stores))
                                    @php
                                        $colors = ['bg-primary', 'bg-danger', 'bg-secondary', 'bg-warning']; // Define your colors here
                                        $textcolors = ['text-white', 'text-white', 'text-white', 'text-white'];
                                        $btncolors = ['btn-light', 'btn-light', 'btn-light', 'btn-light'];
                                        $btextcolors = ['text-primary', 'text-danger', 'text-primary', 'text-primary'];
                                    @endphp
                                    <div class="row row-lg">
                                        @foreach($stores as $index=>$store)
                                            ...
                                            <div class="col-6 col-md-4">
                                                <a href="{{ url('/store/'.$store->id) }}" class="link-to-tab" style="cursor:pointer;">
                                                    <div class="feature-box text-center pb-4 {{ $bgColor }} {{$textClass}}">
                                                        <i class="icon-shopping-cart"></i>
                                                        <div class="feature-box-content">
                                                            <h3 class=" {{$textClass}}">{{$store->name}}</h3>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
