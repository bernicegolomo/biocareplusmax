						...
						<div class="tab-pane fade show active" id="dashboard" role="tabpanel">
							<div class="dashboard-content">
								...
								@if(isset($referralLink) && !empty($referralLink))
									<p><strong>REFERRAL LINK -</strong> <a href="{{$referralLink}}" target="_blank">{{$referralLink}}</a></p>
									<div class="mb-4"></div>
								@endif

								<a href="{{url('/newdownline')}}" class="btn btn-primary btn-sm">Add Downline</a>
								<a href="{{url('/listdownlines')}}" class="btn btn-danger btn-sm">List View</a>
