					...
					<div class="col-lg-9 order-lg-last order-1 tab-content">
						<div class="tab-pane fade show active" id="dashboard" role="tabpanel">
							<div class="dashboard-content">
								...
								<a href="{{url('/admin/newcategory')}}" class="btn btn-primary btn-sm">Add Category</a>
                                                                ...
                                                                <p>
                                                                    <div class="dropdown-primary dropdown open">
                                                                        ...
                                                                        <div class="dropdown-menu" aria-labelledby="dropdown-2" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                                            <a class="dropdown-item waves-light waves-effect" href="{{url('admin/newcategory', Illuminate\Support\Facades\Crypt::encrypt($category->id))}}">Edit</a>

                                                                            <div class="dropdown-divider"></div>
                                                                                <a class="dropdown-item waves-light waves-effect" href="{{url('deletecategory', Illuminate\Support\Facades\Crypt::encrypt($category->id))}}" onclick="return confirm(' Are you sure you want to delete this category?.');">Delete</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </p>
