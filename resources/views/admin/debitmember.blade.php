					...
					<nav aria-label="breadcrumb" class="breadcrumb-nav">
						<div class="container">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="{{url('/admin/earnings')}}">Members Earnings</a></li>
					...
					<div class="col-lg-9 order-lg-last order-1 tab-content">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<form  action="{{url('debitearnings')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-xs-12">
                                                    ...
                                                    <select name="type" class="form-input form-wide" required>
                                                        ...
                                                        <option value="Stockist Voucher">Stockist Voucher</option>
                                                        <option value="Stockist Free Voucher">Stockist Free Voucher</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-xs-12 mt-4">
                                                    <div class="form-group">
                                                        <label>Enter the value in &#8358; </label>
